...
<p class="collection-deck">Modern, extensible Python project management</p>

[Open repository](https://github.com/pypa/hatch){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 7,235 stars, a recent default\-branch push, and MIT licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **License:** MIT
- **Archived:** false
- **Latest release:** hatch\-v1\.18\.1
- **Latest commit:** <code>6a2b14f466a27e833a2e398eeed7c40867efee6c</code>
- **Popularity:** 7,235 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/pypa/hatch">https://api.github.com/repos/pypa/hatch</a> — observed `2026-09-17T12:15:00+00:00`
