...
<p class="collection-deck">Grafana Tempo is a high volume, minimal dependency distributed tracing backend.</p>

[Open repository](https://github.com/grafana/tempo){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 5,477 stars, a recent default\-branch push, and AGPL\-3\.0 licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **Latest commit:** <code>2ccb56786133b41049ac85f088d12a82f43858a3</code>
- **Popularity:** 5,477 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/grafana/tempo">https://api.github.com/repos/grafana/tempo</a> — observed `2026-09-17T12:15:00+00:00`
