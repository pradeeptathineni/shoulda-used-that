...
<p class="collection-deck">How Python does AI. Agents, realtime voice, image generation, embeddings. Every model, every interface, typed end to end.</p>

[Open repository](https://github.com/pydantic/pydantic-ai){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 20,007 stars, a recent default\-branch push, and MIT licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **Latest commit:** <code>9e9fdc4ba18da5b277822dadbf2ab6e2af4ee070</code>
- **Popularity:** 20,007 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/pydantic/pydantic-ai">https://api.github.com/repos/pydantic/pydantic-ai</a> — observed `2026-09-17T12:15:00+00:00`
