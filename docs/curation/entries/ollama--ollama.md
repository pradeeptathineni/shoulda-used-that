...
<p class="collection-deck">Get up and running with Kimi, GLM, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models.</p>

[Open repository](https://github.com/ollama/ollama){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 181,241 stars, a recent default\-branch push, and MIT licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **Latest commit:** <code>5ed8dde3a7a5bf4c9047a8a91906b4f6788f60b9</code>
- **Popularity:** 181,241 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/ollama/ollama">https://api.github.com/repos/ollama/ollama</a> — observed `2026-09-17T12:15:00+00:00`
