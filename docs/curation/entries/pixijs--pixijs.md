...
<p class="collection-deck">The HTML5 Creation Engine: Create beautiful digital content with the fastest, most flexible 2D WebGL renderer.</p>

[Open repository](https://github.com/pixijs/pixijs){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 48,176 stars, a recent default\-branch push, and MIT licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **License:** MIT
- **Archived:** false
- **Latest release:** v8\.21\.0
- **Latest commit:** <code>ecd3797cf9b57766b045f3eea8388db9677744f8</code>
- **Popularity:** 48,176 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/pixijs/pixijs">https://api.github.com/repos/pixijs/pixijs</a> — observed `2026-09-17T12:15:00+00:00`
