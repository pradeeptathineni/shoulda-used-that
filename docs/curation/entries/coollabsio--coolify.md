...
<p class="collection-deck">An open-source, self-hostable PaaS alternative to Vercel, Heroku &amp; Netlify that lets you easily deploy static sites, databases, full-stack applications and 280+ one-click services on your own servers.</p>

[Open repository](https://github.com/coollabsio/coolify){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 61,914 stars, a recent default\-branch push, and Apache\-2\.0 licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **License:** Apache-2.0
- **Archived:** false
- **Latest release:** v4\.3\.21
- **Latest commit:** <code>255ee926217236626110eba85d3a1ad6b1119cf9</code>
- **Popularity:** 61,914 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/coollabsio/coolify">https://api.github.com/repos/coollabsio/coolify</a> — observed `2026-09-17T12:15:00+00:00`
