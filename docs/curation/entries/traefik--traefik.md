...
<p class="collection-deck">The Cloud Native Application Proxy</p>

[Open repository](https://github.com/traefik/traefik){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 64,877 stars, a recent default\-branch push, and MIT licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **License:** MIT
- **Archived:** false
- **Latest release:** v3\.7\.13
- **Latest commit:** <code>e75250a31ae773e50e9c16514e3aebcb92059042</code>
- **Popularity:** 64,877 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/traefik/traefik">https://api.github.com/repos/traefik/traefik</a> — observed `2026-09-17T12:15:00+00:00`
