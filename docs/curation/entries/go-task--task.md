...
<p class="collection-deck">A fast, cross-platform build tool inspired by Make, designed for modern workflows.</p>

[Open repository](https://github.com/go-task/task){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 16,156 stars, a recent default\-branch push, and MIT licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **License:** MIT
- **Archived:** false
- **Latest release:** v3\.53\.1
- **Latest commit:** <code>e165a4cfa3ae044849b85651eaa600ad891b2917</code>
- **Popularity:** 16,156 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/go-task/task">https://api.github.com/repos/go-task/task</a> — observed `2026-09-17T12:15:00+00:00`
