...
**Why:** Selected as a strong prior\-art checkpoint after cross\-source discovery and maintainer review; live metadata showed 599 stars, a recent default\-branch push, and Apache\-2\.0 licensing; the reviewed exception was: The official SLSA GitHub generator implements a named provenance standard and is included for that bounded control role\.\. A star records consideration, not adoption\.<br>
