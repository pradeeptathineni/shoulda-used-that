...
<p class="collection-deck">☁️ Nextcloud server, a safe home for all your data</p>

[Open repository](https://github.com/nextcloud/server){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 36,826 stars, a recent default\-branch push, and AGPL\-3\.0 licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **License:** AGPL-3.0
- **Archived:** false
- **Latest release:** v35\.0\.0
- **Latest commit:** <code>e51769ca941fb0223a3c95c1dbc58325ac56ea1f</code>
- **Popularity:** 36,826 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/nextcloud/server">https://api.github.com/repos/nextcloud/server</a> — observed `2026-09-17T12:15:00+00:00`
