...
<p class="collection-deck">Milvus is a high-performance, cloud-native vector database built for scalable vector ANN search</p>

[Open repository](https://github.com/milvus-io/milvus){ .md-button .md-button--primary }

## Why it is here

**Need:** Compare proven retrieval, indexing, vector, graph, and RAG components before implementing a knowledge layer\.<br>
**Why:** Included for this collection after public metadata and fit review; live metadata showed 46,139 stars, a recent default\-branch push, and Apache\-2\.0 licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **Latest commit:** <code>31798810557fe1b2d0df7d52955487bc92888c2c</code>
- **Popularity:** 46,139 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/milvus-io/milvus">https://api.github.com/repos/milvus-io/milvus</a> — observed `2026-09-17T12:15:00+00:00`
