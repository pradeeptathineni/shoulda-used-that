...
<p class="collection-deck">🤗 Diffusers: State-of-the-art diffusion models for image, video, and audio generation in PyTorch.</p>

[Open repository](https://github.com/huggingface/diffusers){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 34,531 stars, a recent default\-branch push, and Apache\-2\.0 licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **Latest commit:** <code>654dac8880acda22dd7b9fa0531afaaedd1335fa</code>
- **Popularity:** 34,531 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/huggingface/diffusers">https://api.github.com/repos/huggingface/diffusers</a> — observed `2026-09-17T12:15:00+00:00`
