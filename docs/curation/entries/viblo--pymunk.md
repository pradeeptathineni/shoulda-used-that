...
<p class="collection-deck">Pymunk is a easy-to-use pythonic 2d physics library that can be used whenever  you need 2d rigid body physics from Python</p>

[Open repository](https://github.com/viblo/pymunk){ .md-button .md-button--primary }
...
- **Latest commit:** <code>6287ce6d9223d1d79d28b2c26f37499f45b445b8</code>
- **Popularity:** 1,065 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/viblo/pymunk">https://api.github.com/repos/viblo/pymunk</a> — observed `2026-09-17T12:15:00+00:00`
