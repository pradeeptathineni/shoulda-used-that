...
<p class="collection-deck">Search infrastructure for AI</p>

[Open repository](https://github.com/chroma-core/chroma){ .md-button .md-button--primary }

## Why it is here

**Need:** Compare proven retrieval, indexing, vector, graph, and RAG components before implementing a knowledge layer\.<br>
**Why:** Included for this collection after public metadata and fit review; live metadata showed 29,315 stars, a recent default\-branch push, and Apache\-2\.0 licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **Latest commit:** <code>ec22d992d774d4e9c16743920c4883021cdd0d47</code>
- **Popularity:** 29,315 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/chroma-core/chroma">https://api.github.com/repos/chroma-core/chroma</a> — observed `2026-09-17T12:15:00+00:00`
