...
<p class="collection-deck">Git with a cup of tea! Painless self-hosted all-in-one software development service, including Git hosting, code review, team collaboration, package registry and CI/CD</p>

[Open repository](https://github.com/go-gitea/gitea){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 58,041 stars, a recent default\-branch push, and MIT licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **License:** MIT
- **Archived:** false
- **Latest release:** v1\.27\.3
- **Latest commit:** <code>be7cde75395b179d1ada9d2c97ede0217076d1fe</code>
- **Popularity:** 58,041 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/go-gitea/gitea">https://api.github.com/repos/go-gitea/gitea</a> — observed `2026-09-17T12:15:00+00:00`
