...
<p class="collection-deck">The LLM Evaluation Framework</p>

[Open repository](https://github.com/confident-ai/deepeval){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 18,311 stars, a recent default\-branch push, and Apache\-2\.0 licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **License:** Apache-2.0
- **Archived:** false
- **Latest release:** python\-v4\.2\.0
- **Latest commit:** <code>12a38b07a9fb8e58e39a4ffc51097cf6737498f2</code>
- **Popularity:** 18,311 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/confident-ai/deepeval">https://api.github.com/repos/confident-ai/deepeval</a> — observed `2026-09-17T12:15:00+00:00`
