...
<p class="collection-deck">A docker-powered PaaS that helps you build and manage the lifecycle of applications</p>

[Open repository](https://github.com/dokku/dokku){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 32,145 stars, a recent default\-branch push, and MIT licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **License:** MIT
- **Archived:** false
- **Latest release:** v0\.38\.27
- **Latest commit:** <code>1632a40ce789e248d49318007e67ed6ced3e1a64</code>
- **Popularity:** 32,145 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/dokku/dokku">https://api.github.com/repos/dokku/dokku</a> — observed `2026-09-17T12:15:00+00:00`
