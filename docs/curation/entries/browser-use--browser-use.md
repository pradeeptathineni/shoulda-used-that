...
<p class="collection-deck">Agents that use the browser.</p>

[Open repository](https://github.com/browser-use/browser-use){ .md-button .md-button--primary }
...
**Why:** Included for this collection after public metadata and fit review; live metadata showed 114,908 stars, a recent default\-branch push, and MIT licensing\. These signals support discovery, not code, security, or adoption approval\.<br>
...
- **Latest commit:** <code>d8110c5ff87ccba887aaa726cdb780f2f84bef8d</code>
- **Popularity:** 114,908 stars observed at `2026-09-17T12:15:00+00:00`
...
- <a href="https://api.github.com/repos/browser-use/browser-use">https://api.github.com/repos/browser-use/browser-use</a> — observed `2026-09-17T12:15:00+00:00`
