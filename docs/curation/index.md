---
title: "Pradeep's ShouldaUsedThat OSS Curation"
description: "A public, evidence-bound map of strong OSS to consider across Pradeep Tathineni's engineering and creative interests before building another implementation."
tags:
  - "OSS curation"
  - "evidence"
---
# Pradeep&#x27;s ShouldaUsedThat OSS Curation

<div class="catalog-hero">
  <p class="catalog-kicker">Evidence before enthusiasm</p>
  <p class="catalog-lead">A public, evidence-bound map of strong OSS to consider across Pradeep Tathineni&#x27;s engineering and creative interests before building another implementation.</p>
...
!!! info "Meaning before ranking"
    This catalog records evidence\-bound decisions for named needs and does not claim a universal best\-OSS ranking or automatic adoption recommendation\. Stars are bookmarks; each recommendation is bound to the need and evidence shown on its entry.

## Catalog at a glance

This export contains **221 reviewed records** across **12 public collections**. **221 records** were current at `2026-09-17T12:15:00+00:00`. Counts describe this bounded snapshot; they are not popularity scores.

Search understands repository names, roles, needs, disposition labels, collection titles, and aliases such as **AWS, Terraform, cloud engineering, infrastructure as code, 3D vision, CV, VLM, image processing, creative coding, data visualization, generative art, GenAI, LLM, agentic AI, Kubernetes at home, NAS, home lab, self\-hosted, emergent systems, generative nature, nature simulation, GitHub stars, open source curation, prior art, DevOps, GitOps, SRE, cloud native, Python development, Python tooling, information retrieval, knowledge systems, vector search, SBOM, release security, supply chain security, frontend engineering, full stack, web development**.
...
<article class="catalog-card">
  ...
  <p class="catalog-card__role"><strong>Role</strong> creative-coding and data-visualization prior art</p>
...
<article class="catalog-card">
  ...
  <p class="catalog-card__role"><strong>Role</strong> platform engineering and software-delivery prior art</p>
  <p class="catalog-card__need"><strong>Need</strong> Compare established build, workflow, GitOps, runtime, observability, and developer-platform components before creating delivery machinery.</p>
</article>
<article class="catalog-card">
  <div class="catalog-card__meta"><span class="status-chip status-chip--reference">Reference</span> <span class="freshness-chip freshness-chip--current">current</span></div>
...
<article class="catalog-card">
  ...
  <p class="catalog-card__role"><strong>Role</strong> web engineering and interface-system prior art</p>
...
<article class="catalog-card">
  ...
  <p class="catalog-card__role"><strong>Role</strong> computer-vision and multimodal prior art</p>
...
<article class="catalog-card">
  ...
  <p class="catalog-card__role"><strong>Role</strong> nature, physics, and simulation prior art</p>
...
<article class="catalog-card">
  ...
  <p class="catalog-card__role"><strong>Role</strong> generative-AI and agent-system prior art</p>
...
<article class="catalog-card">
  ...
  <p class="catalog-card__role"><strong>Role</strong> retrieval, search, and knowledge-system prior art</p>
