...
description: Evidence-bound OSS decisions before another custom implementation.
hide:
  - toc
---
...
- **Used here** is backed by repository or configuration evidence and a named role.
